...
<body>
		...
		<nav class="navbar navbar-default _navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="https://shushi.asia/">Welcome To....</a>
				</div> 

		    
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<img src="./images/shushi.png" class="nav navbar-nav navbar-right"> 
	...
	<section class="contact " >
		<div class="container">
	        <form class="row  login" method="POST" action="<?php echo site_url('Welcome/masukuser');?>">
